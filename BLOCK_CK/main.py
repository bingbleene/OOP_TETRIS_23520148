...
game_win_surface = title_font.render("YOU WIN", True, Colors.yellow)
...
pygame.time.set_timer(GAME_UPDATE, menu.run_menu())
...
while True:
	...
	if game.game_over == True:
		if game.game_win == True:
		    screen.blit(game_win_surface, (345, 450, 50, 50))
		else:
